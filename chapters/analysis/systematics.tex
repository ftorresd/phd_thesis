...
\begin{table}[ht]
  \begin{center}
    \caption{A summary table of systematic uncertainties in the Higgs boson decaying into $ \Upsilon(1S,2S,3S) + \gamma$, affecting the final yields of the MC samples.}
...
\begin{table}[ht]
  \begin{center}
    \caption{A summary table of systematic uncertainties in the \Z(H) decaying into $ \Upsilon(1S,2S,3S) + \gamma$, affecting the signal fits.}
...
%\begin{table}[ht]
  %\begin{center}
    ...
    %\caption{A summary table of systematic uncertainties in the Higgs boson decaying into $ \Upsilon(1S,2S,3S) + \gamma$, affecting the signal fits.}
    ...
    %\begin{table}[ht]
      %\begin{center}
        ...
        %\caption{A summary table of yields in the Higgs boson decaying into $\Upsilon(1S,2S,3S) + \gamma$}
        ...
        %\begin{table}[ht]
          %\begin{center}
            ...
            %\caption{A summary table of yields in the Z boson decaying into  $\Upsilon(1S,2S,3S) + \gamma$}
