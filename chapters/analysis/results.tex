...
% \input{figures/tables/UpperLimits}
\input{figures/tables/latexBRLimits_Cat123}
...
%\resizebox{.5\width}{!}{\input{figures/tables/UpperLimits}}
% \input{figures/tables/UpperLimits}
\input{figures/tables/latexBRLimits_Cat0}
