...
\end{center}\vspace*{-.5cm}
\caption{The \PT photon distributions from data and signal events for Z decaying in $\Upsilon(1S,2S,3S)$ + $\gamma$ Group I of selection cuts. The plotis normalized to the unit of area.}
...
% Cat1 & $|\eta_{SC}| < 1.444$ (Barrel)         \\
%      & $R9 >$ 0.94 (High R9)                           \\ \hline
% Cat2 & $|\eta_{SC}| < 1.444$ (Barrel)         \\
%      & $R9 <$ 0.94 (Low R9)                            \\ \hline
% Cat3 & $1.566 < |\eta_{SC}| < 2.5$ (Endcap)   \\
...
\begin{table}[ht]
\begin{center}
\input{figures/tables/FinalZYieldsLatex}
...
\begin{table}[ht]
\begin{center}
\input{figures/tables/FinalHYieldsLatex}
