...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[htbp]{0.4\textwidth}
    ...
    \label{direct}
  \end{subfigure}
  \caption{\todo[inline]{Melhorar a qualidade das imagens.} Example of leading order diagrams for the indirect and direct production mechanisms. In thees diagrams, the $h$ can also be understood as a $Z$ or a Higgs boson.}
...
\todo[inline]{verificar resultados se outros foram publicados.}