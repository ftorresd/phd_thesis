...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth,keepaspectratio]{figures/rpc/performance/barrel_eff_vs_intL.png}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{figures/rpc/performance/endcap_eff_vs_intL.png}
    \caption{<caption>}
    \label{eff_run2}
\end{figure}
