...
% \begin{figure}%
%     \centering
%     \subfloat[]{{\includegraphics[width=0.55\textwidth,keepaspectratio]{figures_and_tables/rpc/lumi_plot.png} }}%
%     % \qquad
%     \subfloat[]{{\includegraphics[width=0.35\textwidth,keepaspectratio]{figures_and_tables/rpc/lumi_table.png} }}%
