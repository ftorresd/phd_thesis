...
\thesistitle{Search for Z and Higgs boson decaying into $\Upsilon + \gamma$ in pp collisions at CMS/LHC} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{Doctor in Science, on the field of Physics} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\dedicatory{For my mother\ldots} 
...
\input{chapters/theory/sm_results}
\input{chapters/theory/higgs_results}
\input{chapters/theory/rare_decays}

% detector
\input{chapters/experimental_setup/intro_and_lhc}
...
\input{chapters/experimental_setup/rpc_csc}
